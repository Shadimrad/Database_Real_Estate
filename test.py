...
class TestMainFunctions(unittest.TestCase):
    ...
    def create_sample_data(self):
        ...
        listings = [
            Listing(listing_id=1, seller_id=1, bedrooms=2, bathrooms=1, listing_price=200000, zip_code="ZipCode1",
                    date_of_listing=date(2023, 4, 1), agent_id=1, office_id=1, status="sold"),
            ...
            Listing(listing_id=3, seller_id=3, bedrooms=4, bathrooms=3, listing_price=400000, zip_code="ZipCode3",
                    date_of_listing=date(2023, 4, 1), agent_id=1, office_id=4, status="sold"),
            Listing(listing_id=4, seller_id=4, bedrooms=5, bathrooms=4, listing_price=500000, zip_code="ZipCode4",
                    date_of_listing=date(2023, 4, 1), agent_id=2, office_id=2, status="sold"),
            ...
            Listing(listing_id=6, seller_id=6, bedrooms=7, bathrooms=6, listing_price=700000, zip_code="ZipCode6",
                    date_of_listing=date(2023, 4, 1), agent_id=2, office_id=6, status="sold"),
            Listing(listing_id=7, seller_id=1, bedrooms=8, bathrooms=7, listing_price=800000, zip_code="ZipCode1",
                    date_of_listing=date(2023, 4, 1), agent_id=3, office_id=6, status="sold"),
            ...
            Listing(listing_id=9, seller_id=3, bedrooms=10, bathrooms=9, listing_price=1000000, zip_code="ZipCode3",
                    date_of_listing=date(2023, 4, 1), agent_id=3, office_id=3, status="sold"),
            Listing(listing_id=10, seller_id=4, bedrooms=11, bathrooms=10, listing_price=1100000, zip_code="ZipCode4",
                    date_of_listing=date(2023, 4, 1), agent_id=4, office_id=5, status="sold")
        ...
        sales = [
            Sale(sale_id=1, listing_id=1, buyer_id=1, sale_price=195000, date_of_sale=date(2023, 4, 17), agent_id=1),
            Sale(sale_id=2, listing_id=2, buyer_id=2, sale_price=290000, date_of_sale=date(2023, 4, 17), agent_id=2),
            Sale(sale_id=3, listing_id=3, buyer_id=1, sale_price=390000, date_of_sale=date(2023, 4, 17), agent_id=1),
            Sale(sale_id=4, listing_id=4, buyer_id=2, sale_price=490000, date_of_sale=date(2023, 4, 17), agent_id=2),
            Sale(sale_id=5, listing_id=5, buyer_id=1, sale_price=590000, date_of_sale=date(2023, 4, 17), agent_id=1),
            Sale(sale_id=6, listing_id=6, buyer_id=2, sale_price=690000, date_of_sale=date(2023, 4, 17), agent_id=2),
            Sale(sale_id=7, listing_id=7, buyer_id=1, sale_price=790000, date_of_sale=date(2023, 4, 17), agent_id=3),
            Sale(sale_id=8, listing_id=8, buyer_id=2, sale_price=890000, date_of_sale=date(2023, 4, 17), agent_id=3),
            Sale(sale_id=9, listing_id=9, buyer_id=1, sale_price=990000, date_of_sale=date(2023, 4, 17), agent_id=3),
            Sale(sale_id=10, listing_id=10, buyer_id=2, sale_price=1090000, date_of_sale=date(2023, 4, 17), agent_id=4),
            Sale(sale_id=11, listing_id=1, buyer_id=1, sale_price=195000, date_of_sale=date(2023, 4, 17), agent_id=1),
            Sale(sale_id=12, listing_id=2, buyer_id=2, sale_price=290000, date_of_sale=date(2023, 4, 17), agent_id=2),
            Sale(sale_id=13, listing_id=3, buyer_id=1, sale_price=390000, date_of_sale=date(2023, 4, 17), agent_id=1),
            Sale(sale_id=14, listing_id=4, buyer_id=2, sale_price=490000, date_of_sale=date(2023, 4, 17), agent_id=2),
            Sale(sale_id=15, listing_id=5, buyer_id=1, sale_price=590000, date_of_sale=date(2023, 4, 17), agent_id=1),
            Sale(sale_id=16, listing_id=6, buyer_id=2, sale_price=690000, date_of_sale=date(2023, 4, 17), agent_id=2)

        ]

        commissions = [
            Commission(commission_id=1, agent_id=1, sale_id=1, commission_amount=3900, commission_date=date(2023, 4, 17)),
            Commission(commission_id=2, agent_id=2, sale_id=2, commission_amount=5800, commission_date=date(2023, 4, 17)),
            Commission(commission_id=3, agent_id=1, sale_id=3, commission_amount=7800, commission_date=date(2023, 4, 17)),
            Commission(commission_id=4, agent_id=2, sale_id=4, commission_amount=9700, commission_date=date(2023, 4, 17)),
            Commission(commission_id=5, agent_id=1, sale_id=5, commission_amount=11700, commission_date=date(2023, 4, 17)),
            Commission(commission_id=6, agent_id=2, sale_id=6, commission_amount=13600, commission_date=date(2023, 4, 17)),
            Commission(commission_id=7, agent_id=3, sale_id=7, commission_amount=15600, commission_date=date(2023, 4, 17)),
            Commission(commission_id=8, agent_id=3, sale_id=8, commission_amount=17500, commission_date=date(2023, 4, 17)),
            Commission(commission_id=9, agent_id=3, sale_id=9, commission_amount=19500, commission_date=date(2023, 4, 17))
        ]

        monthly_commissions = [
            MonthlyCommission(monthly_commission_id=1, agent_id=1, year=date(2023, 4, 17).year, month=date(2023, 4, 17).month, total_commission=3900),
            MonthlyCommission(monthly_commission_id=2, agent_id=2, year=date(2023, 4, 17).year, month=date(2023, 4, 17).month, total_commission=5800),
            MonthlyCommission(monthly_commission_id=3, agent_id=3, year=date(2023, 4, 17).year, month=date(2023, 4, 17).month, total_commission=15600),
            MonthlyCommission(monthly_commission_id=4, agent_id=4, year=date(2023, 4, 17).year, month=date(2023, 4, 17).month, total_commission=0),
            MonthlyCommission(monthly_commission_id=5, agent_id=1, year=date(2023, 4, 17).year, month=date(2023, 4, 17).month, total_commission=11700),
            MonthlyCommission(monthly_commission_id=6, agent_id=2, year=date(2023, 4, 17).year, month=date(2023, 4, 17).month, total_commission=13600),
            MonthlyCommission(monthly_commission_id=7, agent_id=3, year=date(2023, 4, 17).year, month=date(2023, 4, 17).month - 1, total_commission=19500)
    ...
    def test_get_top_offices(self):
        ...
        """
        top_offices = get_top_offices(self.session, date(2023, 4, 17).year, date(2023, 4, 17).month)
    ...
    def test_get_top_agents(self):
        ...
        """
        top_agents = get_top_agents(self.session, date(2023, 4, 17).year, date(2023, 4, 17).month)
    ...
    def test_get_average_days_on_market(self):
        ...
        """
        average_days_on_market = get_average_days_on_market(self.session, date(2023, 4, 17).year, date(2023, 4, 17).month)
        expected_output = 16
    ...
    def test_get_average_selling_price(self):
        ...
        """
        average_selling_price = get_average_selling_price(self.session, date(2023, 4, 17).year, date(2023, 4, 17).month)
    ...
    def test_insert_monthly_commissions(self):
        ...
        """
        monthly_commissions = insert_monthly_commissions(self.session, date(2023, 4, 17).year, date(2023, 4, 17).month)
        expected_output = [
